 ...
 */
static char *font = "Meslo LG M DZ:style=Regular:pixelsize=23:lcdfilter=lcddefault:hintstyle=hintnone:rgba=rgb:antialias=true:autohint=false";
...
//static char *font = "JetBrains Mono:style=Regular:pixelsize=23:lcdfilter=lcddefault:hintstyle=hintnone:rgba=rgb:antialias=true:autohint=false";
